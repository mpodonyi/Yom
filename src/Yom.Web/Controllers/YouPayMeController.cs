...
using Yom.Web.Models.YouPayMe;
using SystemControlCenter.Helper;
using Yom.Web.Models.ReferenceUser;

namespace Yom.Web.Controllers
{
    public class YouPayMeController : Controller
    {

        private IReferenceUserService ReferenceUserService;
        private IPaymentService PaymentService;

        public YouPayMeController(IPaymentService paymentService, IReferenceUserService referenceUserService)
        {
        ...
        [HttpPost]
        public ActionResult Create(YouPayMeCreateModel model)
        {
            if (ModelState.IsValid)
            {
                var retVal = PaymentService.Create(PaymentType.YouPayMe, model.ReferenceUser, model.Amount, model.Description);
